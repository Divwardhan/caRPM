        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center justify-between w-full gap-8 lg:gap-12">
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start px-4 lg:px-0">
              <a href="#category" className="group bg-yellow-400 hover:bg-yellow-300 text-black font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center">
                Explore Solutions
