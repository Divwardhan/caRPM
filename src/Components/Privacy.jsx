        ...
        <div className="bg-white shadow rounded-lg p-8">
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <div className="space-y-4">
              ...
              <p>
              This Privacy Policy applies to information we may collect from users, visitors, and/or customers of devices, websites and apps (“Products”, “Services”), including GaragePro apps (Android & iOS), GaragePro website (<a href ='https://garagepro.in/'>https://garagepro.in/</a>, <a href='https://garagepro.shop'>https://garagepro.shop</a>), CaRPM (<a href='https://carpm.in/'>https://carpm.in/</a>), GarageBook apps (Android & iOS), AutoCat apps (Android & iOS), AI DashScan apps (Android & iOS), and any other apps offered by Zymbia on Play Store (<a href='https://play.google.com/store/apps/developer?id=CaRPM'>https://play.google.com/store/apps/developer?id=CaRPM</a>) and App Store, including but without limitation to any other mobile application services offered from time to time by Zymbia Interactive Technologies Private Limited (“Zymbia”, “We”, “Our”, “Us”). Any reference to “Users”, “you” or “your” in this Privacy Policy refers to both Visitors and Customers, as the case may be. If you do not agree to the Privacy Policy, please do not use our services.
<br/><br/>
Zymbia may change all or part of this Privacy Policy from time to time. An up-to-date version of our Privacy Policy will be posted on <a href='https://carpm.in/'>https://carpm.in/</a> . Your continued use of any of our apps, devices, software, websites or other services after the date of any such revision or replacement constitutes your consent to our collection, use and disclosure of your personal information in accordance with the revised or replaced Privacy Policy.</p>
            </div>
